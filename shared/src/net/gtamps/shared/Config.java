...
final public class Config {
    ...
    public static final int SOCKET_MAX_SEND_BUFFER_SIZE = 60000;
    public static final int SOCKET_MAX_RECEIVE_BUFFER_SIZE = 60000;
    public static final int SOCKET_TIMEOUT = 3000;
    public static final boolean SOCKET_KEEP_ALIVE_ENABLED = true;
    public static final boolean SOCKET_TCP_NO_DELAY = true;
    public static final long SOCKET_LATENCY = 33;
    public static final long IMPULS_FREQUENCY = 33;
