...
public class Vector3BufferManager {
    ...
    public Vector3BufferManager(FloatBuffer buffer, int size) {
    ...
    public Vector3BufferManager(int maxElements) {
    ...
    @Override
    public Vector3BufferManager clone() {
        buffer.position(0);
