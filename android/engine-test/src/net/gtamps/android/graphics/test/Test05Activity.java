...
import net.gtamps.android.graphics.test.scenes.Test05Scene;
 ...
 * Time: 17:57
 */
public class Test05Activity extends RenderActivity {

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        renderAction = new Test01Action(new Test05Scene());
