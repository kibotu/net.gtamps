...
public class Test09Scene extends SceneGraph {
    ...
    public void onSurfaceCreatedInternal(GL10 gl10) {
        ...
        Object3D object3D = new Object3D(PACKAGE_NAME + "masteryi_obj");
        object3D.addTexture(new Texture(R.drawable.masteryi_ichigo, Texture.Type.u_Texture01, true));
        object3D.getMaterial().setShininess(32);
        add(object3D);
    }
}
