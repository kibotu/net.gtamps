...
//        PHONG_RIGGED(R.raw.phong_rigged_vs, R.raw.phong_ps),
    ...
    public static void load() {
        for (Shader.Type type : Shader.Type.values()) {
            type.shader = new Shader(type, Registry.getContext().getApplicationContext());
        }
    }
    ...
    public Shader(Type shaderType, Context context) {
        this(shaderType.vs, shaderType.ps, context);
    }
