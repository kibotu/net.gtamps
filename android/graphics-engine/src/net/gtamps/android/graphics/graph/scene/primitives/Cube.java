...
public class Cube extends RenderableNode {
    ...
    public void onCreateInternal(GL10 gl10) {
        ...
        mesh.addVertex(c, -c, -c, 0, -c, 0, 0, 0);
        mesh.addVertex(c, -c, c, 0, -c, 0, c, 0);
        mesh.addVertex(-c, -c, c, 0, -c, 0, c, c);
        mesh.addVertex(-c, -c, -c, 0, -c, 0, 0, c);
        mesh.addVertex(c, c, -c, 0, c, 0, 0, 0);
        mesh.addVertex(-c, c, -c, 0, c, 0, c, 0);
        mesh.addVertex(-c, c, c, 0, c, 0, c, c);
        mesh.addVertex(c, c, c, 0, c, 0, 0, c);
        mesh.addVertex(c, -c, -c, c, 0, 0, 0, 0);
        mesh.addVertex(c, c, -c, c, 0, 0,  c, 0);
        mesh.addVertex(c, c, c, c, 0, 0, c, c);
        mesh.addVertex(c, -c, c, c, 0, 0, 0, c);
        mesh.addVertex(c, -c, c, -0, -0, c, 0, 0);
        mesh.addVertex(c, c, c, -0, -0, c, c, 0);
        mesh.addVertex(-c, c, c, -0, -0, c, c, c);
        mesh.addVertex(-c, -c, c, -0, -0, c, 0, c);
        mesh.addVertex(-c, -c, c, -c, -0, -0, 0, 0);
        mesh.addVertex(-c, c, c, -c, -0, -0, c, 0);
        mesh.addVertex(-c, c, -c, -c, -0, -0, c, c);
        mesh.addVertex(-c, -c, -c, -c, -0, -0, 0, c);
