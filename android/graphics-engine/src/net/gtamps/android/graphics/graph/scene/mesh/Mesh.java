...
public class Mesh {
    ...
    private void positionZero() {
        if (vertices.getVertices() != null && vertices.getVertices().getBuffer() != null)
            vertices.getVertices().getBuffer().position(0);
        if (vertices.getNormals() != null && vertices.getNormals().getBuffer() != null)
            vertices.getNormals().getBuffer().position(0);
        if (vertices.getUvs() != null && vertices.getUvs().getBuffer() != null)
            vertices.getUvs().getBuffer().position(0);
        if (vertices.getWeights() != null && vertices.getWeights().getBufferWeights() != null)
            vertices.getWeights().getBufferWeights().position(0);
        if (vertices.getWeights() != null && vertices.getWeights().getBufferInfluences() != null)
            vertices.getWeights().getBufferInfluences().position(0);
    ...
    public void update() {
        if (vbo != null && isDirty) {
            Registry.getRenderer().update(this);
            isDirty(false);
        }
    }
