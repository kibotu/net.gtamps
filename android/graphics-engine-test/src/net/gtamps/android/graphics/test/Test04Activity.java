...
import net.gtamps.android.graphics.test.scenes.Test04Scene;
 ...
 * Time: 17:57
 */
public class Test04Activity extends RenderActivity {

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        renderAction = new Test01Action(new Test04Scene());
