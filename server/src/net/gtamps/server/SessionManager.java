...
public final class SessionManager {
	 ...
	 */
	public String getSessionForMessage(final NewMessage message, final Connection<?> connection) throws ServerException {
		if (connection == null) {
	...
	public void sendMessage(final NewMessage msg) throws NoSuchElementException {
