...
public class Configuration {
	...
	private static enum Titles{
		Tile_Image_Path, Map_Save_Path, Max_Floors, Map_Size_X, Map_Size_Y
	}
	...
	public static HashMap<String, Object> getConfigurations(){
		...
		configs.put(Titles.Map_Save_Path.toString(), savePath);
	...
	public static void setConfig(String title, String value) {
		...
		if(title.equals(Titles.Map_Save_Path.toString())){
			savePath = value;
		}
